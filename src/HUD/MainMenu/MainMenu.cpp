...
HUD::MainMenu::MainMenu::MainMenu(Game* game)
    : m_game(game), m_caveNumberRenderer(game, 3), m_selectArrow(game, 1), m_selectCaveFileArrow(game, 1), m_selectOptionsArrow(game, 1), m_credits(game, 1024), m_loadingTileRenderer(game)
